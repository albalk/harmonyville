...
export default function Main() {
    ...
    return (
        <div className="bg-white w-full">
            {/* titulo */}
            <div id='fondoTitulo'>
                <h1 className='titulos py-64 mb-24 lg:pt-44 lg:pb-60 lg:mb-24 font-bold text-5xl lg:text-8xl flex justify-center text-center text-white'>Bienvenidos a <br></br>Harmonyville</h1>
            </div>
